...
setup(name="rhythmbox-ampache",
      ...
      url="https://github.com/lachlan-00/rhythmbox-ampache",
      data_files=[
          (lib_dir+"/rhythmbox/plugins/rhythmbox-ampache", ["rhythmbox-ampache.plugin", "rhythmbox-ampache.py", "AmpacheBrowser.py", "AmpacheConfigDialog.py"]),
          ("share/rhythmbox/plugins/rhythmbox-ampache", ["ampache-prefs.ui", "ampache.ico", "ampache.png"]),
          ("share/glib-2.0/schemas", ["org.gnome.rhythmbox.plugins.rhythmbox-ampache.gschema.xml"]),
          ],
      )
